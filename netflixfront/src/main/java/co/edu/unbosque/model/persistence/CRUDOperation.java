...
/**
 * Interfaz genérica para operaciones CRUD (Crear, Leer, Actualizar, Eliminar). Define los métodos
 * básicos para la manipulación de datos de tipo D, y la búsqueda de entidades de tipo E.
 *
