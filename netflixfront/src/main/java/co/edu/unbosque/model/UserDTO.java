...
/**
 * Data Transfer Object (DTO) para representar datos de usuario. Esta clase se utiliza para
 * transferir datos de usuario entre diferentes capas de la aplicación.
 */
public class UserDTO {
  ...
  /**
   * Constructor con argumentos para inicializar los campos de nombre de usuario, contraseña, nombre
   * completo y correo electrónico del usuario.
   *
