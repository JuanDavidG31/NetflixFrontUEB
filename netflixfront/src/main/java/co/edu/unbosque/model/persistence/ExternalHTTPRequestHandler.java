...
/**
 * Clase que maneja las solicitudes HTTP externas. Proporciona métodos para realizar solicitudes
 * GET, POST, PUT y DELETE, así como para parsear respuestas JSON a objetos Java.
 */
public class ExternalHTTPRequestHandler {
  ...
  /**
   * Realiza una solicitud GET para obtener todos los usuarios y parsea la respuesta JSON a una
   * lista de UserDTO.
   *
   * @param url La URL a la que se realizará la solicitud GET.
  ...
  /**
   * Realiza una solicitud GET para obtener todos los registros de Excel y parsea la respuesta JSON
   * a una lista de ExcelDTO.
   *
   * @param url La URL a la que se realizará la solicitud GET.
  ...
  /**
   * Realiza una solicitud GET para obtener todas las películas y parsea la respuesta JSON a una
   * lista de MovieDTO.
   *
   * @param url La URL a la que se realizará la solicitud GET.
