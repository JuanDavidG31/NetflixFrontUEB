...
/**
 * Bean que gestiona las interacciones relacionadas con las películas. Permite buscar películas,
 * filtrar por género y acceder a los detalles de una película. Es un bean de alcance de sesión, lo
 * que significa que su estado se mantiene a través de múltiples solicitudes dentro de una sesión de
 * usuario.
 */
@Named("MovieBean")
@SessionScoped
public class MovieBean implements Serializable {
  ...
  /**
   * Busca una película por nombre y redirige a la página de detalles de la película si se
   * encuentra. Muestra un mensaje de error si la película no se encuentra.
   */
  public void search() {
    ...
    if (existente) {
      ...
      FacesContext.getCurrentInstance()
          .addMessage(
              "messages",
              new FacesMessage(
                  FacesMessage.SEVERITY_ERROR, "Error", "La pelicula no se encuentra disponible."));
    }
  }
